...
- Size is a feature. `pnpm build` prints raw + gzip bytes per entrypoint; core should stay ~1.5 KB gzip. Codegolf techniques are welcome in the core (regex pipelines, stash placeholders, dispatch maps) but keep tests exhaustive to match.
